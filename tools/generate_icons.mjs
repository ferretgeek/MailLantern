...
const svg = await readFile(resolve(root, "src/mail_lantern/static/favicon.svg"));
...
await writeFile(resolve(root, "src/mail_lantern/static/favicon.ico"), Buffer.concat([header, ...images]));
await sharp(svg)
  .resize(180, 180)
  .png({ compressionLevel: 9 })
  .toFile(resolve(root, "src/mail_lantern/static/apple-touch-icon.png"));
